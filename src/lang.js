export const lang = {
    ...
    loginToMyNalogHelp: 'Введите свой логин (инн) и пароль от личного кабинета налогоплательщика, чтобы автоматически отправлять данные о выполненных заказах и получать чеки.',
